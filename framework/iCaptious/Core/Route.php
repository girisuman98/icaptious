...
class Route
{
     ...
     * @var array
     */
    private static $HttpScope = ['GET', 'POST', 'PUT', 'DELETE', 'CONNECT', 'OPTIONS', 'TRACE', 'PATCH', 'CONNECT', 'PURGE'];
     ...
     * @param array  $assign
     */
    public static function Compose($view, $ViewName, $assign = [])
    {
    ...
    public static function __callStatic($method, $args)
    {
        if (Arr::InArray(Str::Upper($method), self::$HttpScope)) {
            ...
            if (method_exists(new static(), $method)) {
                return Call::FuncArr([get_called_class(), $method], $args);
            }
