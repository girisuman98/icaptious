...
use iCaptious\Database\Query\Syntax\OrderBy;
...
use iCaptious\Database\Query\Syntax\Where;
// Builder injects itself into query for convestion to SQL string.
use iCaptious\Database\Query\Builder\BuilderInterface;
...
abstract class AbstractBaseQuery implements QueryInterface, QueryPartInterface
{
    ...
    /**
     * @var \iCaptious\Database\Query\Builder\BuilderInterface
     */
    protected $builder;
